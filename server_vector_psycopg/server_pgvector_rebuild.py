...
logging_file_path = os.path.join('db/logging_db/vector_rebuild.log')
...
if env == 'test':
    vectordb_pre_path = '/media/data2/koko/koko_pg_ver/'
    logging_file_path = '/media/data2/koko_pg_ver/logs/koko_pg_ver.log'
elif env == 'prod':
    vectordb_pre_path = '/home/ubuntu/vectordb/'
    logging_file_path = '/home/ubuntu/logs/koko_pg_ver.log'
